	...
	const projects: Project[] = [
		{
			...
			title: "FlyxNodes",
			description:
				"Servicio de hosting gratuito y premium con infraestructura robusta y soporte 24/7. Ofrecemos soluciones de alojamiento web confiables para desarrolladores y empresas.",
		...
		},
		{
			...
			title: "DistopyCraft",
			description:
				"Servidor de Minecraft con experiencia única y comunidad activa. Incluye modos de juego personalizados, eventos especiales y un sistema de economía balanceado.",
		...
		},
		{
			...
			description:
				"Producción y edición de contenido audiovisual para la Asamblea Apostólica del Paraguay. Videos testimoniales y contenido de alta calidad.",
		...
		},
		{
			...
			description:
				"Template base para bots de Discord desarrollado con Discord.JS v14. Incluye comandos básicos, sistema de eventos y estructura modular para facilitar el desarrollo.",
		...
		},
		{
			...
			title: "ChurchTils",
			description:
				"Software de gestión integral para iglesias. Incluye administración de miembros, eventos, finanzas y comunicación. Desarrollado para simplificar la gestión eclesiástica.",
			...
			<header className="relative px-6 py-8">
				<div className="max-w-6xl mx-auto">
					...
					<div className="text-center mb-12">
						...
						>
							Una colección de mis proyectos más destacados, desde servicios de
							hosting hasta desarrollo de software y contenido audiovisual.
						</p>
					</div>
