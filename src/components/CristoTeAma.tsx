...
const CristoTeAma: React.FC<CristoTeAmaProps> = ({ isDark, toggleTheme }) => {
		...
		>
			...
			<main className="px-6 pb-16 relative z-10">
				...
				>
							...
							<AnimatePresence mode="wait">
								...
								>
									...
									<div className="flex justify-center mb-6">
										<div
											className={`p-4 rounded-2xl bg-gradient-to-r ${messages[currentMessageIndex].color}`}
										>
					...
					>
						{[
							...
							},
							{
								...
								description:
									"No es teoría, es experiencia real que cambia tu vida",
								color: "from-yellow-500 to-orange-500",
							},
							{
					...
					<motion.div className="text-center" variants={itemVariants}>
						<div
							className={`max-w-2xl mx-auto p-8 md:p-12 rounded-3xl backdrop-blur-sm ${
								isDark
			...
			<footer className="px-6 py-8 border-t border-white/10 relative z-10">
				<div className="max-w-6xl mx-auto text-center">
					...
					>
						&copy; 2025 AjnebAlRevés · CristoTeAma - Un mensaje de esperanza
						para ti ❤️
					</p>
				</div>
			</footer>
